...
export const SRD_PHYSICAL_CRITICAL_INJURIES = Object.freeze([
  ...
  injury("physical", 14, "Sprained Ankle", "Non-lethal. Mobility −2 and movement is a slow action until a Healing roll is made; no healing time.", { modifier: -2, skills: ["Mobility"], movement: "slow", specialRule: "healingRollEnds" }),
  injury("physical", 15, "Blood in Eyes", "Non-lethal. Observation and Marksmanship −2 until a Healing roll is made; no healing time.", { modifier: -2, skills: ["Observation", "Marksmanship"], specialRule: "healingRollEnds" }),
